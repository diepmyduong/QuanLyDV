...
{
    public partial class FrmSysNation : FormBase
    {
        public FrmSysNation()
        {
            InitializeComponent();
        ...
        protected override void OnReload()
        {
            ...
            var dtChange = this._Project_QLDVDataSet.tbSysDanToc.GetChanges() as _Project_QLDVDataSet.tbSysDanTocDataTable;
            if (dtChange != null)
            {
            ...
            this.tbSysDanTocTableAdapter.Fill(this._Project_QLDVDataSet.tbSysDanToc);
        ...
        protected override void OnSave()
        {
            ...
            try
            {
                tbSysDanTocTableAdapter.Update(dtChange);
                _Project_QLDVDataSet.tbSysDanToc.AcceptChanges();
            }
            catch (Exception ex)
            {
        ...
        private void FrmSysNation_Load(object sender, EventArgs e)
        {
            OnReload();
        }
    }
