...
{
    public partial class FrmSysReligion : FormBase
    {
        public FrmSysReligion()
        {
            InitializeComponent();
        }
        ...
        protected override void OnReload()
        {
            ...
            var dtChange = this._Project_QLDVDataSet.tbSysTonGiao.GetChanges() as _Project_QLDVDataSet.tbSysTonGiaoDataTable;
            if (dtChange != null)
            {
            ...
            this.tbSysTonGiaoTableAdapter.Fill(this._Project_QLDVDataSet.tbSysTonGiao);
        ...
        protected override void OnSave()
        {
            ...
            try
            {
                tbSysTonGiaoTableAdapter.Update(dtChange);
                _Project_QLDVDataSet.tbSysTonGiao.AcceptChanges();
            }
            catch (Exception ex)
            {
        ...
        private void FrmSysReligion_Load(object sender, EventArgs e)
        {
            OnReload();
        }
    }
